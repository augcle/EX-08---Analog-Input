 ...
 *
 * @note
 * VREF is set to 5.0 V (Uno default analog reference). Because the potentiometer is
 * wired to 3.3 V, the maximum ADC reading will be approximately (3.3/5.0)*1023 ≈ 675.
 */
 ...
 * @details
 * In this exercise the potentiometer is wired between 3.3V and GND, so the wiper
 ...
 * 4) Normalizes the voltage from 0..3.3V into a factor t in range 0..1.
...
void loop() {
  ...
  // Normalize 0..3.3V -> 0..1 and clamp
  float t = volt / MAX_INPUT_VOLT;
  t = constrain(t, 0.0, 1.0);

  // 0V purple (255,0,255) -> 3.3V red (255,0,0)
  int r = 255;
  int g = 0;
